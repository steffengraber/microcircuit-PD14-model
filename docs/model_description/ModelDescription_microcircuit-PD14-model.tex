...
\begin{tabular}{
  ...
  \hline 
  total network $\mathcal{P} = \bigcup_{x} x$ & LIF & \parbox{\linewidth}{\vspace{0.5ex}$N= \sum_{x} N_{x}$\\ (see remark \ref{remark:downscaling})\vspace{0.5ex}}\\
  \hline 
   thalamic inputs $\mathcal{T}$ & realizations of Poisson point process & $N_{\mathcal{T}}$ \\
   \hline
   %cortico-cortical inputs $\mathcal{C}=\bigcup_{y}\mathcal{C}_{y}$ & population specific constant currents & $N = \sum_{y} N_{y}$
...
\begin{tabular}{
  ...
  \hline
   $x \in \{\mathcal{E}_{23},\ldots,\mathcal{I}_{6}\}$ & $y \in \{\mathcal{E}_{23},\ldots,\mathcal{I}_{6}\}$ &
				    ...
				    \item random, fixed total number $Q_{yx}$ of connections\cref{def:random_fixed_total_number} (see remark \ref{remark:downscaling})
...
\begin{equation*}
	I_{\mathcal{C}_y} = K_{y,\mathcal{C}_y} \cdot I_{y,\mathcal{C}_y}
  \quad (\forall y\in\{\mathcal{E}_{23},\ldots,\mathcal{I}_{6}\})\, ,
\end{equation*}
	with cortico-cortical in-degree $K_{y,\mathcal{C}_y}$, and mean current
  \begin{equation*}
    I_{y,\mathcal{C}} = \nu_{\mathcal{C}_y} \cdot \bar{I}_{y,\mathcal{C}_y}\cdot\tauS \quad (\forall y\in\{\mathcal{E}_{23}, \dots, \mathcal{I}_{6}\})
  \end{equation*}
...
\item \label{remark:downscaling}
  ...
  \begin{equation}
    \mu_{y,0} = \left(1-\sqrt{f}\right)  \mu_y 
  \end{equation}
  ...
  \begin{equation}
    ...
    =  \mu_y.
  \end{equation}
  (see remark \ref{remark:downscaling_dc}).
